...
void curve_renderer::render_de_casteljau(std::vector<point2d> remaining_control_points, double t) {
	...
	render_de_casteljau(casteljau_points, t);
}
...
void curve_renderer::render_curve()
{
	...
	*************/
	...
	if (dynamic_cast<bezier_curve *>(curve)) {
		render_de_casteljau(curve->get_control_points(), curve->casteljau_t);
	}
}
